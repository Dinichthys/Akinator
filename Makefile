...
all: clean akinator tree_compare


akinator: build build_akin build_stack clean_dump main_akinator.o akinator.o akin_answer.o akin_dump.o akin_io.o akin_run.o akin_structure.o stack my_stdio.o logging.o print_error.o
...
build_akin:
	mkdir build/akinator

build_stack:
	mkdir build/stack

build_comp:
	mkdir build/tree_compare
